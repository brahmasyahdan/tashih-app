...
{{-- Sidebar --}}
<aside id="sidebar"
       class="fixed lg:static inset-y-0 left-0 z-30 w-64 
        ...
        <div class="flex items-center gap-3 mb-1">
            <div class="w-10 h-10 bg-emas-500 rounded-lg flex items-center justify-center shadow-md">
                <svg viewBox="0 0 40 40" class="w-7 h-7 text-white fill-current">
                    <path d="M20 4 L22 14 L32 10 L26 18 L36 20 L26 22 L32 30 L22 26 L20 36 L18 26 L8 30 L14 22 L4 20 L14 18 L8 10 L18 14 Z"/>
                </svg>
            </div>
            <div>
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3">
        ...
        @if($role === 'admin')
            ...
            <x-sidebar-item href="{{ route('admin.export.index') }}" icon="download" label="Export Excel"/>
